...
3. **Test-Driven Safety:** Refactoring is only possible with a solid test suite. If tests are missing, **Extract Function** or **Move Method** only _after_ suggesting a baseline test.
...
1. **Declare the Smell:** Start every refactor response with: _"Smell Detected: [Name]. Proposed Refactoring: [Catalog Name]."_
