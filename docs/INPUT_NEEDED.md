...
Every issue file describes *what* to build but none contains the `### [N]. SubtaskName` decomposition format required by the analyst role. Dev coder cannot start work without these.  
